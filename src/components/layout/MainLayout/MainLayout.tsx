  ...
  const navSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/stock-move', label: t('nav.stockMove') },
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/product-price', label: t('nav.productPrice') },
        { to: '/approval', label: t('nav.approval') },
        { to: '/permission', label: t('nav.permission') },
      ],
    },
    {
      label: t('nav.sectionRestaurant'),
      items: [
        { to: '/tables', label: t('nav.tables') },
      ],
    },
  ]
