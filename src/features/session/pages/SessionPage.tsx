...
import { posConfigApi } from '@/features/pos-config/services/pos-config.service'
            ...
            <tbody className="divide-y divide-gray-100">
              {isLoading ? (
                ...
                <tr key={s.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-5 py-3 text-right text-gray-700">{Number(s.openingBalance).toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                  <td className="px-5 py-3 text-right text-gray-700">
                    {s.closingBalance != null ? Number(s.closingBalance).toLocaleString(undefined, { minimumFractionDigits: 2 }) : '-'}
                  </td>
