            ...
            {isLoading ? (
              ...
              <tr key={s.id} className="hover:bg-gray-50">
                ...
                <td className="px-5 py-3 text-right">
                  {s.qtyIn > 0 ? (
                    <span className="text-green-600 font-medium">+{s.qtyIn.toLocaleString()}</span>
                  ) : '-'}
                </td>
                <td className="px-5 py-3 text-right">
                  {s.qtyOut > 0 ? (
                    <span className="text-red-500 font-medium">-{s.qtyOut.toLocaleString()}</span>
                  ) : '-'}
                </td>
                <td className="px-5 py-3 text-right font-bold text-gray-800">{s.balanceQty.toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
