...
import type { Uom, CreateUomPayload } from './uom.types'
    ...
    <div className="w-96 bg-white border-l border-gray-200 flex flex-col h-full shadow-xl">
      ...
      <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-4">
        <div>
          ...
          <input className="input" value={form.uomCode}
            onChange={(e) => setForm(f => ({ ...f, uomCode: e.target.value.toUpperCase() }))}
            disabled={isEdit} placeholder="PCS" />
        </div>
        <div>
