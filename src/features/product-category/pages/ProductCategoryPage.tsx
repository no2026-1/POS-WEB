...
import { productCategoryApi } from '../services/product-category.service'
import type { ProductCategory, CreateProductCategoryPayload } from '../types/product-category.types'
