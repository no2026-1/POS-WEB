...
import type { Vendor, CreateVendorPayload } from './vendor.types'
      ...
      <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input className="input" value={form.vendorNo}
              onChange={(e) => setForm(f => ({ ...f, vendorNo: e.target.value }))}
              disabled={isEdit} placeholder="V0001" />
          </div>
          <div>
