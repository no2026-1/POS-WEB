...
import type { CreateStockAdjustPayload } from '../types/stock-adjust.types'
...
function NewAdjustPanel({ onClose, onToast }: {
  ...
  const isValid = form.adjustNo && form.adjustDate && form.locationId > 0
      ...
      <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="input bg-gray-50 text-gray-500 font-mono text-sm">{form.adjustNo}</div>
          </div>
          <div>
